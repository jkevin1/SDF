...
GLuint GLUtil::createShader(GLenum type, const char* src) {
...
GLuint GLUtil::loadShader(GLenum type, const char* filename) {
...
GLuint GLUtil::createProgram(std::list<GLuint> shaders) {
